...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-gray-900 text-white relative overflow-hidden pt-24">
      <div className="container mx-auto relative z-10 h-[calc(100vh-6rem)] px-4 sm:px-6 lg:px-0">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 h-full relative">
          {/* Left Content */}
          <motion.div
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif">
              Hello! I'm <br />
              <p className="font-bold mt-3 lg:mt-5 text-4xl sm:text-5xl md:text-6xl lg:text-8xl bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                Nasir Uddin
              </p>
            </h2>
            <p className="text-gray-400 mb-6 lg:mb-8 max-w-2xl text-base sm:text-lg mt-4 lg:mt-5 mx-auto lg:mx-0">
          ...
          >
            <img
              ...
              className="w-full max-w-[300px] xl:max-w-[370px] 2xl:max-w-[800px] mx-auto h-auto"
            />
          </motion.div>
        </div>
      </div>
